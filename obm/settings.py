"""
Django settings for obm project.
...
ROOT_URLCONF = 'obm.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ BASE_DIR / "obm" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'obm.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'jsy776@gmail.com'
EMAIL_HOST_PASSWORD = 'tmddbs7443?'
